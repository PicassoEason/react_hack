...
import { Heart, Info,Cookie,BedSingle,HeartHandshake,Accessibility } from 'lucide-react';
...
const ServiceButtons = () => (
  <div className="flex space-x-2 p-4">
    ...
    <button className="flex-1 bg-orange-200 text-orange-700 py-2 rounded-full flex items-center justify-center">
      <BedSingle size={16} className="mr-3" />
      臨時住宿
    </button>
    <button className="flex-1 bg-purple-400 text-white py-2 rounded-full flex items-center justify-center">
